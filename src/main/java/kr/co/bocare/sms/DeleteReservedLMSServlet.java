...
@WebServlet(urlPatterns = {"/deleteReservedLMS"})
public class DeleteReservedLMSServlet  extends HttpServlet {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeleteReservedLMSServlet.class);
    ...
    private void process(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (PrintWriter out = response.getWriter();
             ...
             PreparedStatement preparedStatement = connection.prepareStatement("DELETE FROM MMS_MSG WHERE ETC1 = ?");
        ) {
