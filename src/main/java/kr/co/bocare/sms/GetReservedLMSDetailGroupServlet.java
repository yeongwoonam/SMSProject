...
@WebServlet(urlPatterns = {"/getReservedLMSDetailGroup"})
public class GetReservedLMSDetailGroupServlet extends HttpServlet {

    private static final Logger LOGGER = LoggerFactory.getLogger(GetReservedLMSDetailGroupServlet.class);
    ...
    private void process(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (PrintWriter out = response.getWriter();
             ...
             PreparedStatement preparedStatement = connection.prepareStatement("SELECT REQDATE,  PHONE,  MSG, ETC2  FROM MMS_MSG WHERE ETC1 = ? AND ETC2 LIKE ?  ORDER BY SENTDATE desc");
        ) {
